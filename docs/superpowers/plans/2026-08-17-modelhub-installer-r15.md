...
- [x] **Step 7: Tag and publish R15.** Create and push annotated tag `modelhub-installer-20260817-r15` at the reviewed branch head, publish `ModelHub Installer R15` as a non-draft non-prerelease release, and upload exactly the four verified files.
- [x] **Step 8: Verify the public release.** Query GitHub for tag, release state, asset names, sizes, and digests; download the public checksum and verify all three content assets again.
